...
[GitHub](https://www.github.com) has emerged as a very popular tool for collaborative code development in the software development community. The utility of source code repositories expands far beyond use in professional software development. In fact, it has been shown to be extremely useful for  number of other endeavors. The purpose of this client is to provide an interface for users of R to be able to have web-accessible access to their code directly from their R sessions.
...
```{r}
getPermlink(repoDev, "vignettes/rGithubClient.Rmd")
```
